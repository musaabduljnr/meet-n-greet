-- ============================================================================
-- KOUNTRY WAYNE VIP PLATFORM: SEED ADMIN USER (admin@wayne.com)
...
DECLARE
    new_user_id UUID;
    target_email TEXT := 'admin@wayne.com';
    target_password TEXT := '@Password123';
    target_full_name TEXT := 'Wayne Executive Producer';
BEGIN
    ...
    ELSE
        ...
        SET 
            ...
            raw_user_meta_data = jsonb_build_object('full_name', target_full_name),
            updated_at = NOW()
    ...
    RAISE NOTICE 'Admin user % (%) set up successfully with SUPER_ADMIN role (UID: %)', target_full_name, target_email, new_user_id;
END $$;
